...
//============================================================================
//Q_DEFINE_THIS_MODULE("qutest_cpp") // name of this file for assertions
...
#if HSI_CLK_DIV == 1U
    std::uint32_t const rcc_cr_hisdiv = 0U;              // div by 1
    std::uint32_t const flash_latency = FLASH_ACR_LATENCY_3WS;
#elif HSI_CLK_DIV == 2U
    std::uint32_t const rcc_cr_hisdiv = RCC_CR_HSIDIV_0; // div by 2
    std::uint32_t const flash_latency = FLASH_ACR_LATENCY_1WS;
#elif HSI_CLK_DIV == 4U
    std::uint32_t const rcc_cr_hisdiv = RCC_CR_HSIDIV_1; // div by 4
    std::uint32_t const flash_latency = FLASH_ACR_LATENCY_0WS;
#elif HSI_CLK_DIV == 8U
    std::uint32_t const rcc_cr_hisdiv = RCC_CR_HSIDIV;   // div by 8
    std::uint32_t const flash_latency = FLASH_ACR_LATENCY_0WS;
#else
